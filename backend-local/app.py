...
class VoxMedEngine:
    ...
    def analyze_safety(self, scanned_text, allergies, medications):
        ...
        system_instructions = (
            ...
            "3. İlaç Etkileşimi Kontrolü: Düzeltilen içerik listesini, kullanıcının aktif ilaç listesiyle karşılaştır. İçerikteki maddelerin kullanıcının kullandığı ilaçlarla (örn: Atorvastatin veya Lipitor gibi kolesterol ilaçları ile greyfurt; Warfarin veya Coumadin ile kızılcık, ıspanak, yeşil çay gibi yüksek K vitamini içeren maddeler; aspirin ile alkol vb.) bilinen klinik etkileşimlerini denetle. Eğer bir çakışma varsa kullanıcıyı açıkça uyar ve ürünü tehlikeli ('safe': false) olarak işaretle. Çakışma yoksa veya ilaç listesi boş ise bu adımı güvenli geç.\n"
